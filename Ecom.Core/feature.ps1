...
$featuresPath = Join-Path -Path $rootPath -ChildPath "src\EcomCore.Application\Features"
$endpointsPath = Join-Path -Path $rootPath -ChildPath "src\EcomCore.API\Endpoints"
...
function Create-Feature-Files {
    ...
    $requestContent = @"
namespace EcomCore.Application.Features.$FeatureName.$directoryType.$OperationName
{
...
"@
    ...
    $endpointContent = @"
using EcomCore.Application.Features.$FeatureName.$directoryType.$OperationName;
using MediatR;
using MinimalAPI.Attributes;
using MinimalAPI.Endpoints;
using Shared.Responses;

namespace EcomCore.API.Endpoints.$FeatureName.$endpointDirectoryType
{
    [Route("$(${FeatureName}.ToLower())")]
    public class ${OperationName}Endpoint(IMediator mediator) : EndpointBase<${OperationName}Request, ${OperationName}Response>(mediator)
    {
        [Http$httpMethod]
